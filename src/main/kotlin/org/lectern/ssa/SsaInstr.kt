...
sealed class SsaInstr {
    ...
    data class LoadFunc(
        ...
        val constants: List<org.lectern.lang.Value>,
        val defaultValues: List<org.lectern.lang.DefaultValueInfo?> = emptyList()
    ) : SsaInstr() {
        override val usedValues: List<SsaValue> = emptyList()
    }
    ...
    data class LoadClass(
        ...
        val methods: Map<String, org.lectern.lang.MethodInfo>
    ) : SsaInstr() {
        override val usedValues: List<SsaValue> = emptyList()
    }
